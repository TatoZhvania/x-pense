    ...
    <footer className="pt-[142px] pb-[60px]">
      <div className="container mx-auto">
        <div className="flex flex-col items-center text-center lg:flex-row lg:items-start lg:text-left lg:justify-between gap-y-8">
          <div data-aos="fade-up" data-aos-offest="200" data-aos-delay="300">
            <img src={logo} alt="logo" />
          </div>
          <div data-aos="fade-up" data-aos-offest="200" data-aos-delay="400">
          ...
          <div data-aos="fade-up" data-aos-offest="200" data-aos-delay="500">
          ...
          <div data-aos="fade-up" data-aos-offest="200" data-aos-delay="600">
            ...
            <form className="bg-pinl-200 max-w-[349px] mb-[10px]">
              <div className="h-[62px] p-[7px] flex border border-dark rounded-lg">
                ...
                />
                <button className="btn btn-sm bg-accent hover:bg-accentHover w-[100px] text-white">
                  {form.btnText}
                </button>
              </div>
            </form>
